...
namespace PULSE.WinUI.Pages.Part
{
    public partial class ucPartDetails : UserControl
    {
        ...
        public string TitleEdit { get; set; } = "Edit Part";


        public delegate void PartUpsertHandler(PartUpsertRequest data, int ProductId);
        public event PartUpsertHandler ModelSubmitted;

        public ucPartDetails()
        {
            InitializeComponent();
        }
        ...
        private void pnlProducNumberWrapper_Validating(object sender, CancelEventArgs e)
        {
