...
import 'package:pulse_admin/components/molecules/select/single/available_size_static_single_select.dart';
...
class AvailableSizeSingleSelectStaticFormGroup<T extends AbstractSingleSelect>
  ...
  final AvailableSize? initialValue;
  final String? Function(AvailableSize?)? validator;
  final double width;

  const AvailableSizeSingleSelectStaticFormGroup({
    Key? key,
    this.controller,
    this.enabled = true,
    this.clearable = true,
  ...
  Widget build(BuildContext context) {
    ...
    return SpacedColumn(
        ...
        children: [
          ...
          FormBuilderField<AvailableSize>(
            name: name,
            initialValue: initialValue,
            validator: validator,
            builder: (FormFieldState<AvailableSize> field) {
              return InputDecorator(
                ...
                child: AvailableSizeStaticSingleSelect(
                    text: "",
                    clearable: clearable,
                    enabled: enabled,
                    value: field.value,
